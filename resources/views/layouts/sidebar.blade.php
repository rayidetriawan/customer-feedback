<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box mt-2 mb-2">
        ...
        <a href="index.html" class="logo logo-dark">
            <span class="logo-sm">
                <img src="https://mactel.co.id/wp-content/uploads/2022/03/of_Logo2-840x480-Copy.png" alt="" height="22">
            </span>
            <span class="logo-lg">
