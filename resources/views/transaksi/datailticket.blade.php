                ...
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-body login-modal p-5 pb-4">
                        ...
                        <p class="text-white-50 mb-0">
                            Untuk penilaian Sesuai Kinerja Teknisi.
                        </p>
                        <h5 class="text-white fs-15 mt-4 mb-0">Review</h5>
                        <p class="text-white-50 mb-0 fs-15"> #{{ $cekreview->idTiket }} -
        ...
        <div class="col-xl-9">
            <div class="card">
                <div class="card-body p-4 mb-0">
                    <h6 class="fw-semibold text-uppercase mb-3">Request Description</h6>
