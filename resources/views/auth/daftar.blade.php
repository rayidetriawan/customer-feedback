                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-lg-5">
                                <div class="p-lg-5 p-5">
                                    <div class="mb-0 mt-2">
                                        <h4 class="text-primary fw-semibold">Lengkapi form daftar !</h4>
                                        <p class="text-muted">Sudah Punya Akses ? <a href="{{ route('login') }}">Login disini !</a></p>
                                    </div>
                                    
                                    <div class="mt-1 mb-2">
                                        <form action="{{ route('daftar.add') }}" method="POST">
                                            @csrf
                                            <div class="mb-2">
                                                <label for="username" class="form-label">Nama</label>
                                                <input type="text" class="form-control" autocomplete="off" id="username"
                                                    name="nama" placeholder="Enter name" required>
                                            </div>
                                            
                                            <div class="mb-2">
                                                <label for="username" class="form-label">Alamat</label>
                                                <input type="text" class="form-control" autocomplete="off" id="username"
                                                    name="alamat" placeholder="Enter address" required>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <label for="username" class="form-label">Email</label>
                                                    <input type="email" class="form-control" autocomplete="off" id="username"
